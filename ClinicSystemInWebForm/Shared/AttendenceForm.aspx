<%@ Page Title="" Language="C#" MasterPageFile="~/DoctorMaster.Master" AutoEventWireup="true" CodeBehind="AttendenceForm.aspx.cs" Inherits="ClinicSystemInWebForm.Shared.AttendenceForm" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="AttendenceForm" ContentPlaceHolderID="DoctorMainContent" runat="server">
